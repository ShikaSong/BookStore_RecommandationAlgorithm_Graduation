<template>
  <div>
    ...
    <div style=" display: flex; justify-content: center"><h4 style="color: #333333; height: 2px">时空猎人</h4></div>
    <hr style=" height: 2px">
    <div>
...
<!--      <el-table-column prop="id" label="序号" width="70" sortable align="center"></el-table-column>-->
      <el-table-column  label=""  align="center">
        <template slot-scope="scope">

          <div v-html= "scope.row.content.match(/<img[^>]*>/g)[0]"></div>
          <div style="font-size: 15px; font-weight: bolder">{{scope.row.title}}</div>

        </template>
      </el-table-column>
      <el-table-column prop="description" label="简介"></el-table-column>
      <el-table-column prop="content" label="账号详情">
        <template v-slot="scope">
          <div style="font-size: 30px; font-weight: bold; color: #dd4141">￥{{scope.row.price}}</div>
          <div style="display: flex; align-items: flex-start; ">
            <el-tag size="mini" style = "display: inline " type="success">官方验号</el-tag>
            <el-tag size="mini" style = "display: inline " type="info">安全保障</el-tag>
          </div>
          <el-tag size="mini" style = "display: inline " type="warning">找回包赔</el-tag>
          <el-button @click="showContent(scope.row)" size="mini">显示内容</el-button>
        </template>
      </el-table-column>
<!--      <el-table-column prop="content" label="详情页">-->
<!--        <template v-slot="scope">-->
<!--          <el-button @click="$router.push('/gamesDetail?id=' + scope.row.id)" size="mini">在详情页显示</el-button>-->
<!--        </template>-->
<!--      </el-table-column>-->
